# Extraction accuracy run - 2026-08-28T06:29:50.757Z
...
[Figure] The image displays a detailed diagram of the water cycle, illustrating the continuous movement of water on, above, and below the surface of the Earth. It shows various processes including: precipitation (to land and ocean), evaporation (from precipitation, water surface, vegetation, land, soil, reservoir, and ocean), transpiration (from vegetation), condensation, surface runoff, infiltration, percolation (deep), subsurface flow, groundwater outflow, and saltwater intrusion. Key components like the water table, soil moisture (indicated by purple), groundwater (indicated by light blue), and the ocean are labeled. The diagram uses arrows to depict the direction of water movement. Additionally, factual information at the bottom states that the ocean covers 71 percent of Earth's surface, equating to 196,950,000 sq mi (510,000,000 sq km).
```
...
**Actual extracted text:**
```
[Figure] An anatomical illustration of the human digestive system, depicting the major organs and their relative positions within the upper torso. It shows the pathway food takes from the oral cavity (mouth), pharynx, esophagus, stomach, small intestine, and large intestine, ending at the rectum/anus. Key accessory organs illustrated include the salivary glands (yellow), liver (red), gallbladder (green), and pancreas (pale yellow/orange).
```
