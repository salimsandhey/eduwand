# Extraction accuracy run - 2026-08-28T06:24:46.886Z
...
[Figure] A diagram illustrating the Earth's water cycle, showing the continuous movement of water through various reservoirs. The diagram depicts the processes of precipitation (to land and ocean), surface runoff, infiltration into the ground, percolation (deep) to groundwater, evaporation (from precipitation, water surfaces, land, soil, reservoirs, and oceans), transpiration from vegetation, condensation forming clouds, subsurface flow, groundwater outflow, and surface outflow. Key components labeled include clouds, mountains, land with vegetation, a lake/river, a reservoir with a dam, and the ocean. The interaction between groundwater and the ocean through saltwater intrusion is also shown. A legend distinguishes "soil moisture" (purple shaded area) and "groundwater" (blue shaded area). The diagram also includes text stating that "ocean covers 71 percent of Earth's surface" and provides its area in square miles and square kilometers.
```
...
**Actual extracted text:**
```
[Figure] A sagittal view diagram of the human digestive system within an outline of the upper body, illustrating the major organs involved in digestion. The path of food is shown starting from the mouth and pharynx (orange), through the esophagus (long orange tube), into the stomach (light orange pouch). Associated organs include the salivary glands (yellow masses near the mouth/pharynx), the liver (large dark red organ), gallbladder (small green organ under the liver), and pancreas (pale yellow organ behind the stomach). The food then passes into the small intestine (coiled orange tube) and finally the large intestine (green tube surrounding the small intestine), ending with the rectum/anus (blue/green gradient at the bottom). The diagram highlights the anatomical arrangement and connectivity of these organs.
```
