...
export const NAV_ITEMS: NavItem[] = [
  ...
  { to: "/ai-limits", label: "AI Limits", icon: "sparkle", roles: ["platform_admin"] },
  { to: "/ai-costs", label: "AI Costs", icon: "chart", roles: ["platform_admin"] },
  { to: "/ai-calls", label: "AI Call Log", icon: "filter", roles: ["platform_admin"] },
  { to: "/teacher-plans", label: "Teacher Plans", icon: "users", roles: ["platform_admin"] },
  { to: "/payments", label: "Payments", icon: "chart", roles: ["platform_admin"] },
