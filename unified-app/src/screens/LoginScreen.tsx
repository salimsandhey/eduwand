...
const styles = StyleSheet.create({
  ...
  eyeButton: { position: "absolute", right: 12, minWidth: 24, minHeight: 24, alignItems: "center", justifyContent: "center" },
  button: {
    borderRadius: 10,
    padding: 14,
    alignItems: "center",
  ...
  forgotPassword: { fontSize: 13, fontWeight: "600", textAlign: "center", marginTop: 16, padding: 4 },
