...
import { View, Text, Pressable, StyleSheet, ScrollView, ActivityIndicator, ViewStyle } from "react-native";
...
function StatTile({
  ...
  return (
    <View style={[styles.statTile, { backgroundColor: colors.surface, borderColor: colors.border }, shadow]}>
...
const styles = StyleSheet.create({
  ...
  statTile: { flex: 1, borderWidth: 1, borderRadius: 14, padding: 14, alignItems: "center" },
  statValue: { fontSize: 22, fontWeight: "700" },
  statLabel: { fontSize: 11, marginTop: 4, textAlign: "center" },
  banner: { flexDirection: "row", alignItems: "center", gap: 12, borderRadius: 16, padding: 16, marginTop: 20 },
