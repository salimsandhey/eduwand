  ...
  return <Screen>
    <FlatList
      ...
      ListHeaderComponent={<>
        ...
        <Pressable onPress={() => navigation.navigate("AssignmentAiMultiSetup")} style={({ pressed }) => [styles.aiGenerateRow, { backgroundColor: colors.surface, borderColor: colors.border }, pressed && { opacity: pressedOpacity }]} accessibilityRole="button">
...
const styles = StyleSheet.create({
  ...
  aiGenerateRow: { flexDirection: "row", alignItems: "center", gap: 12, marginTop: 12, borderWidth: 1, borderRadius: 16, padding: 14 }, aiGenerateIcon: { width: 40, height: 40, borderRadius: 14, alignItems: "center", justifyContent: "center" }, aiGenerateTitle: { fontSize: 14, fontWeight: "800" }, aiGenerateSubtitle: { marginTop: 2, fontSize: 12, fontWeight: "500" },
